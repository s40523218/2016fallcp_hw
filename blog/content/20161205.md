...
<!-- 以下實際利用  Brython 畫圖 -->
<canvas id="chord1" width="1000" height="1000"></canvas>
<script type="text/python3">
from browser import document as doc
import math
# 準備繪圖畫布
...
w = 20
h = 30
background(100, 10, w, h, 5, 19, ctx)
...
num = 0
for s in mylist:
    #canvasText(70,  32.5, 20, "A", "b", "", "black", ctx)
    canvasText(70,  32.5+num*h, 20, s, "", "", "black", ctx)
    num = num + 1畫線練習
